            ...
            if user_choice == '1':
                ...
                while True:
                    ...
                    if utilities.validate_date(today_input):
                        ...
                        print('Ошибка! Введите дату корректно'
                              ' в формате (ДД.ММ.ГГГГ). Помните:'
                              ' в месяце 1-12, а дней 1-31!'
                              ' Год от 1900 до 2100!')
                if today_input == '0':
                    continue
                ...
                number_of_days = None
                while True:
                    number_of_days_string = (
                        input('Введите число дней N'
                              ' (или 0 для отмены): '))
                ...
                original_data = (data_editor.delete_task
                                 ('family_tasks.txt', original_data))
